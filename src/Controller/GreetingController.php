...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render('@BitBagSyliusMultiCartPlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }

    public function dynamicallyGreetAction(?string $name): Response
    {
        return $this->render('@BitBagSyliusMultiCartPlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
